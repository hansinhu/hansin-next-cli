                ...
                <div className="footer-content">
                    <div className="footer-item">
                        <div className="footer-header">
                            <div className="header" onClick={() => this.toggleTab(1)}>
                                SUPPORT <span><Icon type={this.state.showTab == 1 ? 'down' : 'right' }  style={(info.phone || info.email || info.whatsapp || info.address) ? {display:'block'} : {display:'none'}}/></span>
                            </div>
                            <div className="items" id="items1" style={this.state.showTab == 1 ? { display: 'block'} : {display: 'none'}}>
                                <div className="item" style={info.phone ? { display: 'block'} : {display: 'none'}}>
                                    <Icon type="phone" className="font"/>
                                    <p>{info.phone}</p>
                                </div>
                                <div className="item" style={info.email ? { display: 'block'} : {display: 'none'}}>
                                    <Icon type="mail"  className="font"/>
                                    <p>{info.email}</p>
                                </div>
                                <div className="item" style={info.whatsapp ? { display: 'block'} : {display: 'none'}}>
                                    <i className="iconfont icon-whatsapp font"></i>
                                    <p>{info.whatsapp}</p>
                                </div>
                                <div className={home.isFb ? 'item item-address-fb' : 'item item-address'}  style={info.address ? { display: 'block'} : {display: 'none'}}>
                    ...
                    <div className="footer-item">
                        <div className="footer-header">
                            <div className="header" onClick={() => this.toggleTab(2)}>
                                QUICK LINKS <span><Icon type={this.state.showTab == 2 ? 'down' : 'right'} /></span>
                            </div>
                            <div className="items" id="items2" style={this.state.showTab == 2 ? {display:'block'} : {display:'none'}}>
                                <div className="item item-pointer">
                                ...
                                <div className="item item-pointer">
                                    <Link href="/products?type=top"><p>TOP SELLING</p></Link>
                                </div>
                                <div className="item item-pointer">
                                    <Link href="/products?type=new"><p>NEW ARRIVALS</p></Link>
                                </div>
                                <div className="item item-pointer">
                                    <Link href="/company"><p>COMPANY  PROFILE</p></Link>
                                </div>
                                <div className="item item-pointer">
                    ...
                    <div className = "footer-item" >
                        <div className="footer-header">
                            <div className="header" onClick={() => this.toggleTab(3)}>
                                ABOUT <span><Icon type={this.state.showTab == 3 ? 'down' : 'right' } style={info.intro ? {display:'block'} : {display:'none'}}/></span>
                            </div>
                            <div className="items" id="items3" style={(this.state.showTab == 3 && info.intro) ? {display:'block'} : {display:'none'}}>
                                <div className="item">
                                    <p>{info.intro}</p>
                                </div>
                            </div>
                    ...
                    <div className = "footer-item" >
                        <div className="footer-header">
                            <div className="header header-extra">
                    ...
                    <div className = "footer-bottom" >
                        <p>ONLOON © All Rights Reserved.    POWERED BY ONLOON</p>
                        <p className = "footer-txt" onClick={this.showModal}>User Terms</p>
                        <img src = "../../static/img/footer/credit-cards.png" alt = "0" />
                    </div>
                    <Modal
                        className={home.isFb ? '' : 'modal-footer'}
