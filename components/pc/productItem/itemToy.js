      ...
      <div className="pro-box-inner">
        ...
        <div className="pro-info">
            ...
            <Row>
              ...
              <Col span={12}>
                <Button size="large" loading={btnLoading} onClick={showModal} type="primary" style={{minWidth:50,height:40,padding:'0 10px'}}>
                         ADD TO CART<Icon type="right" style={{display:btnLoading?'none':''}} />
                  </Button>
              </Col>
            </Row>
          </div>
