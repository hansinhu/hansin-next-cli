...
import { getCookie ,strLength} from '../../../../static/js/global';
...
class MenuGroup extends Component {
    ...
    render() {
        ...
        return (
            <div className={this.props.atTop ? 'nav-wrapper nav-wrapper-2 nav-wrapper-4' : 'nav-wrapper nav-wrapper-2 nav-wrapper-4 nav-wrapper-common'}>
                <div className="nav-content" style={this.state.showSearch ? {opacity: 0} : {width:'100%',opacity: 1}} >
                    <div className="nav-content-inner">
                        ...
                        <div className="search-wrapper" onClick={this.toggleShowSearch}>
                            <Icon type="search"  className="input-extra-small" />
                        </div>
                    </div>
                </div>
